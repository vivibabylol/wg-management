...
const SHEET_HEADERS = {
  Shipments:  ['id','bolNum','carrier','customer','status','pol','pod','etd','eta','etaFinal',
                ...
                'doc_commercialInv','doc_entrySummary','doc_customsPaid','doc_finalAddress','doc_inlandBOL',
                ...
                'date_debitNote','date_arrivalNotice','date_carrierFeePaid','date_entrySummary','date_customsPaid','date_inlandBOL',
